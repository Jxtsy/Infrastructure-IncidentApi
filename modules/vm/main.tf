...
# Crear asociacion entre subnet y security group
...
resource "azurerm_linux_virtual_machine" "IN-VM" {
  ...
  # Que version de ubuntu vamos a utilizar
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo su -c 'echo \"MONGO_UR = ${var.mongo_url}\" >> /home/${var.admin_username}/.env'",
...
resource "null_resource" "init-docker" {
